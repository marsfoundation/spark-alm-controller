...
contract ForkTestBase is DssTest {
    ...
    function setUp() public virtual {
        ...
        rateLimits.setRateLimit(mainnetController.LIMIT_USDS_TO_USDC(), 5_000_000e18, uint256(1_000_000e18) / 4 hours);
        rateLimits.setRateLimit(mainnetController.LIMIT_USDC_TO_CCTP(), 5_000_000e18, uint256(1_000_000e18) / 4 hours);

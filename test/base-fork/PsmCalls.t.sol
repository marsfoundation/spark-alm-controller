...
contract ForeignControllerSwapSuccessTestBase is ForkTestBase {
    ...
    {
        vm.prank(relayer);
        amountOut = foreignController.swapExactIn({
    ...
    {
        vm.prank(relayer);
        amountIn = foreignController.swapExactOut({
            assetIn      : address(assetIn),
            assetOut     : address(assetOut),
            amountOut    : amountOut,
...
contract ForeignControllerSwapExactInFailureTests is ForkTestBase {
...
contract ForeignControllerSwapExactInTests is ForeignControllerSwapSuccessTestBase {
...
contract ForeignControllerSwapExactOutFailureTests is ForkTestBase {
    ...
    function test_swapExactOut_notRelayer() external {
        ...
        foreignController.swapExactOut({
            assetIn      : address(nstBase),
            assetOut     : address(usdcBase),
            amountOut    : 1e18,
            maxAmountIn  : type(uint256).max,
...
contract ForeignControllerSwapExactOutTests is ForeignControllerSwapSuccessTestBase {
